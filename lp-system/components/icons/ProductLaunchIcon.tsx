...
/**
 * Product Launch/Box Icon
 * Uses currentColor for theme compatibility (light/dark mode)
 */
export function ProductLaunchIcon({ className = 'w-7 h-7' }: { className?: string }) {
  return (
